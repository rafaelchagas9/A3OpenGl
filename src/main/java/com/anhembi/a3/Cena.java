...
public class Cena implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float randomBallSpeedX = ThreadLocalRandom.current().nextFloat(0.001f, 0.004f);
        int randomBallXDirection = ThreadLocalRandom.current().nextInt(0, 1); // 0 = esquerda, 1 = direita
        float randomBallSpeedY = ThreadLocalRandom.current().nextFloat(0.005f, 0.01f);
    ...
    public void addPaddleSpeed(float ballSpeedY, float ballSpeedX){
        System.out.println("Adicionando: " + ballSpeedX + ", " + ballSpeedY );
        this.paddleSpeedX += ballSpeedX;
        this.paddleSpeedY += ballSpeedY;
        System.out.println("Velocidade: " + this.ballSpeedX + ", " + this.ballSpeedY );
    }
}
